...
Route::post('certificate/download', [HomeController::class, 'certificateDownload'])->name('certificate.download'); // ->middleware('certificate.rate.limit:1,1'); // COMMENTED OUT
