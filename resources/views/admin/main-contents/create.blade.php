                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="participation_categories" id="participation_categories" class="form-control @error('participation_categories') is-invalid @enderror" value="{{ old('participation_categories') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="timeline" id="timeline" class="form-control @error('timeline') is-invalid @enderror" value="{{ old('timeline') }}">
                                    @error('timeline')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
