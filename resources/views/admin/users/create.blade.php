                        ...
                        <div class="row">
                            <div class="col-md-4 col-sm-12">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="first_name" id="first_name" class="form-control"
                                        value="{{ old('first_name') }}" placeholder="{{ Str::title(__('module.user.first_name')) }}">
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 col-sm-12">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="middle_name" id="middle_name" class="form-control"
                                        value="{{ old('middle_name') }}" placeholder="{{ Str::title(__('module.user.middle_name')) }}">
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 col-sm-12">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="last_name" id="last_name" class="form-control"
                                        value="{{ old('last_name') }}" placeholder="{{ Str::title(__('module.user.last_name')) }}">
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 col-sm-12">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="email" name="email" id="email" class="form-control"
                                        value="{{ old('email') }}" placeholder="{{ Str::title(__('module.user.email')) }}">
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 col-sm-12">
                                <div class="form-group mb-3">
                                    ...
                                    <textarea name="address" id="address" class="form-control" placeholder="{{ Str::title(__('module.user.address')) }}">{{ old('address') }}</textarea>
                                </div>
                            </div>
                        </div>
                    </form>
...
@push('scripts')
    <script type="module">
        $(document).ready(function() {
            ...
            $('#state_id').select2({
                placeholder: "{{ __('module.user.select_state') }}",
                allowClear: true,
                ajax: {
            ...
            $('#city_id').select2({
                placeholder: "{{ __('module.user.select_city') }}",
                allowClear: true,
                ajax: {
