    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <form action="{{ route('admin.cms-pages.update', $cmsPage->id) }}" method="POST" id="cmsPageForm">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" name="title" id="title" class="form-control form-control-lg @error('title') is-invalid @enderror" value="{{ old('title', $cmsPage->title) }}" placeholder="Enter page title" required>
                                            @error('title')
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group mb-3">
                                            ...
                                            <textarea name="content" id="content" class="form-control @error('content') is-invalid @enderror" rows="15" placeholder="Enter page content" required>{{ old('content', $cmsPage->content) }}</textarea>
                                            @error('content')
                                                <div class="invalid-feedback">
                                                    <i class="fas fa-exclamation-circle me-1"></i>{{ $message }}
                                                </div>
                                    ...
                                    <div class="card-body">
                                        <div class="form-group mb-3">
                                            ...
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox" id="is_active" name="is_active" value="1" {{ old('is_active', $cmsPage->is_active) ? 'checked' : '' }}>
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" class="form-control" value="{{ $cmsPage->slug }}" readonly>
                                            <small class="form-text text-muted">Slug is auto-generated from title</small>
                                        </div>
                                    </div>
                                </div>
