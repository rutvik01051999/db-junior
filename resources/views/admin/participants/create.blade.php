        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex align-items-center justify-content-between">
                    <h4 class="card-title">Create New Participant</h4>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" class="form-control form-control-lg @error('title') is-invalid @enderror" id="title" name="title" value="{{ old('title') }}" placeholder="Enter participant title" required>
                                            @error('title')
                                                <div class="invalid-feedback">
                                                    <i class="fas fa-exclamation-circle me-1"></i>{{ $message }}
                                                </div>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="number" class="form-control form-control-lg @error('number_of_participants') is-invalid @enderror" id="number_of_participants" name="number_of_participants" value="{{ old('number_of_participants') }}" min="1" placeholder="Enter number of participants" required>
