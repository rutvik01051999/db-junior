...
@section('title', 'Create Guest Of Honour')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Create New Guest Of Honour</h4>
                    <a href="{{ route('admin.guest-of-honours.index') }}" class="btn btn-sm btn-primary">
                        <i class="fas fa-arrow-left"></i> Back to List
                    </a>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.guest-of-honours.store') }}" method="POST" id="guest-of-honour-form">
                        @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" class="form-control form-control-lg @error('season_name') is-invalid @enderror" id="season_name" name="season_name" value="{{ old('season_name') }}" placeholder="Enter season name" required>
                                            @error('season_name')
                                                <div class="invalid-feedback">
                                                    <i class="fas fa-exclamation-circle me-1"></i>{{ $message }}
                                                </div>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" class="form-control form-control-lg @error('guest_name') is-invalid @enderror" id="guest_name" name="guest_name" value="{{ old('guest_name') }}" placeholder="Enter guest name" required>
                                            @error('guest_name')
                                                <div class="invalid-feedback">
                                                    <i class="fas fa-exclamation-circle me-1"></i>{{ $message }}
                                                </div>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <button type="submit" class="btn btn-primary btn-lg">
                                        <i class="fas fa-save me-2"></i> Save Guest Of Honour
                                    </button>
