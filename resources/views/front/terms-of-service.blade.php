...
<div class="row">
                    <div class="col-md-12">
                        ...
                        <p>This page states the Terms and Conditions under which you (Visitor) may visit this website
                            ...
                            binding on all users of this Website.</p>
                        ...
                        <p>You may not sell or modify the content of this Website or reproduce, display, publicly
                            perform, distribute, or otherwise use the materials in any way for any public or commercial
                            purpose without the respective organization’s or entity’s written permission.</p>
                        ...
                        <p>Visitors are prohibited from violating or attempting to violate the security of the Web site,
                            including, without limitation, (1) accessing data not intended for such user or logging into
                            a server or account which the user is not authorized to access, (2) attempting to probe,
                            ...
                            a virus or "Trojan horse" to the Website, overloading, "flooding", "mail bombing" or
                            "crashing", or (4) sending unsolicited electronic mail, including promotions and/or
                            advertising of products or services. Violations of system or network security may result in
                            civil or criminal liability. The business and / or its associate entities will have the
                        ...
                        <p>Visitors may not use the Web Site in order to transmit, distribute, store or destroy material
                            ...
                            or violate any applicable law or regulation, (b) in a manner that will infringe the
                            copyright, trademark, trade secret or other intellectual property rights of others or
                            violate the privacy or publicity of other personal rights of others, or (c) that is
                            libelous, defamatory, pornographic, profane, obscene, threatening, abusive or hateful.</p>

                        <h5>INDEMNITY</h5>
                        <p>The User unilaterally agree to indemnify and hold harmless, without objection, the Company,
                            its officers, directors, employees and agents from and against any claims, actions and/or
                            demands and/or liabilities and/or losses and/or damages whatsoever arising from or resulting
                            from their use of <a href="https://junioreditor.groupbhaskar.in">https://junioreditor.groupbhaskar.in</a>
                            or their
                            breach of the terms.</p>

                        <h5>LIABILITY</h5>
                        <p>User agrees that neither Company nor its group companies, directors, officers or employee
                        ...
                        <p>
                            ...
                            negligent or intentional, inadvertent or advertent. </p>
                        <p>User agrees that Company shall not be responsible or liable to user, or anyone, for the
                            ...
                            amount paid by the User to Company, if any, that is related to the cause of action.</p>
                        ...
                        <p>In no event shall Company or any parties, organizations or entities associated with the
                            ...
                            or not, such organization or entities were advised of the possibility of such damages.</p>
